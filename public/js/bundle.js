...
},{"./app/app":21,"./bootstrap":36}],2:[function(require,module,exports){
...
},{"backbone":8,"backbone.babysitter":3,"backbone.wreqr":4,"underscore":5}],3:[function(require,module,exports){
// Backbone.BabySitter
// -------------------
// v0.1.6
//
...
},{"backbone":8,"underscore":5}],4:[function(require,module,exports){
...
},{"backbone":8,"underscore":5}],5:[function(require,module,exports){
//     Underscore.js 1.6.0
...
},{"./router":25,"./views/app-layout":32,"backbone":8,"backbone.marionette":2}],22:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../models/book":23,"../models/books":24,"../views/book-details":33,"../views/book-list":35,"backbone.marionette":2}],23:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":8}],24:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./book":23,"backbone":8}],25:[function(require,module,exports){
var _ = require('underscore');
...
},{"./controllers/app-controller":22,"backbone.marionette":2,"backbone.radio":6,"underscore":20}],26:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<h1>Bookbone</h1>\n<p>The best collection of books you'll ever see!</p>";
},"useData":true});

},{"hbsfy/runtime":16}],27:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div id=\"header\"></div>\n<div id=\"content\"></div>\n<footer>\n  <p>Made with &lt;3 by <a href=\"https://twitter.com/charca\">Charca</a></p>\n</footer>\n";
},"useData":true});

},{"hbsfy/runtime":16}],28:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "    <img src=\""
    + alias3(((helper = (helper = helpers.cover_url || (depth0 != null ? depth0.cover_url : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"cover_url","hash":{},"data":data}) : helper)))
    + "\" alt=\""
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "\">\n";
},"3":function(depth0,helpers,partials,data) {
    return "    <img src=\"http://d28hgpri8am2if.cloudfront.net/book_images/no_book_cover_lg.jpg\"\n      alt=\"Book Cover not available\">\n";
},"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "<div class=\"col-md-4\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.cover_url : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>\n<div class=\"col-md-8\">\n  <h3>"
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "</h3>\n  <p>By "
...
},{"hbsfy/runtime":16}],29:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;
  ...
  return "<th>"
    ...
    + "</th>\n<td class=\"book-list-item-cover\">\n  <a class=\"thumbnail\" href=\"#details/"
    + alias3(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.cover_url : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  </a>\n</td>\n<td><a href=\"#details/"
    + alias3(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" class=\"book-list-item-title\">"
    + alias3(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"title","hash":{},"data":data}) : helper)))
    + "</a></td>\n<td>"
    + alias3(((helper = (helper = helpers.created_readable || (depth0 != null ? depth0.created_readable : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"created_readable","hash":{},"data":data}) : helper)))
    + "</td>\n<td><a href=\"#\" class=\"delete-book\">Delete</a></td>";
},"useData":true});

},{"hbsfy/runtime":16}],30:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class=\"alert alert-info\" role=\"alert\">\n  <strong>Keyboard shortcuts:</strong>\n  press <span class=\"label label-primary\">g</span> or <span class=\"label label-primary\">t</span> to switch between Grid and Table layouts. Also, you can type the ID # of a book to see its details. Press <span class=\"label label-primary\">esc</span> to go back to the index page.\n</div>\n\n<div class=\"btn-group pull-right\">\n  <button type=\"button\" class=\"btn btn-default change-layout\" data-layout=\"table\">\n    <span class=\"glyphicon glyphicon-th-list\"></span>\n  </button>\n  <button type=\"button\" class=\"btn btn-default change-layout\" data-layout=\"grid\">\n    <span class=\"glyphicon glyphicon-th\"></span>\n  </button>\n</div>\n<table class=\"table table-hover\">\n  <thead>\n    <tr>\n      <th><a href=\"#\" class=\"sort-list\" data-sort-by=\"id\">#</a></th>\n      <th>&nbsp;</th>\n      <th><a href=\"#\" class=\"sort-list\" data-sort-by=\"title\">Title</a></th>\n      <th><a href=\"#\" class=\"sort-list\" data-sort-by=\"created\">Created</a></th>\n      <th>Actions</th>\n    </tr>\n  </thead>\n\n  <tbody></tbody>\n</table>\n\n<h2>Add a book!</h2>\n<form id=\"add-book-form\">\n  <div class=\"form-group\">\n    <label for=\"book-title\">Title</label>\n    <input class=\"form-control\" type=\"text\" id=\"book-title\" name=\"book-title\" placeholder=\"Enter Title\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"book-author\">Author</label>\n    <input class=\"form-control\" type=\"text\" id=\"book-author\" name=\"book-author\" placeholder=\"Enter Author\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"book-cover-url\">Cover Image URL</label>\n    <input class=\"form-control\" type=\"text\" id=\"book-cover-url\" name=\"book-cover-url\" placeholder=\"Enter Cover Image URL\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"book-description\">Description</label>\n    <textarea class=\"form-control\" id=\"book-description\" name=\"book-description\" placeholder=\"Enter Description\">\n    </textarea>\n  </div>\n  <button class=\"btn btn-primary\" id=\"add-book-btn\">Add new Book</button>\n</form>\n";
},"useData":true});

},{"hbsfy/runtime":16}],31:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../templates/app-header.hbs":26,"backbone.marionette":2}],32:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../templates/app-layout.hbs":27,"./app-header":31,"backbone.marionette":2}],33:[function(require,module,exports){
var _ = require('underscore');
var Radio = require('backbone.radio');
...
},{"../templates/book-details.hbs":28,"backbone.marionette":2,"backbone.radio":6,"mousetrap":19,"underscore":20}],34:[function(require,module,exports){
var _ = require('underscore');
var Radio = require('backbone.radio');
var Mousetrap = require('mousetrap');
var Marionette = require('backbone.marionette');
...
},{"../templates/book-list-item.hbs":29,"backbone.marionette":2,"backbone.radio":6,"moment":18,"mousetrap":19,"underscore":20}],35:[function(require,module,exports){
var $ = require('jquery');
var _ = require('underscore');
var Radio = require('backbone.radio');
var Mousetrap = require('mousetrap');
...
},{"../models/book":23,"../templates/book-list.hbs":30,"./book-list-item":34,"backbone.marionette":2,"backbone.radio":6,"jquery":17,"mousetrap":19,"underscore":20}],36:[function(require,module,exports){
var Backbone = require('backbone');
Backbone.$ = require('jquery');

},{"backbone":8,"jquery":17}]},{},[1]);
